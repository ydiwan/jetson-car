...
def generate_launch_description():
    ...
    spawn_x = LaunchConfiguration('x', default='1.91')
    spawn_y = LaunchConfiguration('y', default='0.38')
    ...
    arg_x = DeclareLaunchArgument('x', default_value='1.91', description='X spawn coordinate')
    arg_y = DeclareLaunchArgument('y', default_value='0.38', description='Y spawn coordinate')
    arg_z = DeclareLaunchArgument('z', default_value='0.15', description='Z spawn coordinate')
    arg_yaw = DeclareLaunchArgument('yaw', default_value='3.14159', description='Yaw spawn rotation')
