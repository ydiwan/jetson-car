...
def generate_launch_description():
    ...
    map_file = LaunchConfiguration('map_file', default='500/cyber_city_without_brim.yaml')
    ...
    arg_map_file = DeclareLaunchArgument('map_file', default_value='500/cyber_city_without_brim.yaml')
